    ...
    try:
        with conexao.cursor() as cursor:
            ...
            for tabela, coluna, spec in (
                ...
                ("pessoas_autorizadas", "termo_midia_id", "INT"),
                ("pessoas_autorizadas", "texto_autorizacao", "TEXT"),
                ("pessoas_autorizadas", "status_autorizacao", "VARCHAR(30) DEFAULT 'rascunho'"),
                ("pessoas_autorizadas", "token_autorizacao", "VARCHAR(80)"),
                ("pessoas_autorizadas", "enviado_em", "TIMESTAMP"),
                ("pessoas_autorizadas", "respondido_em", "TIMESTAMP"),
                ("pessoas_autorizadas", "respondido_por_email", "VARCHAR(180)"),
